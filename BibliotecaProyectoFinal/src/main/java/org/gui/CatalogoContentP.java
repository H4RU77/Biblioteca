...
public class CatalogoContentP extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        idiomaTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                idiomaTFActionPerformed(evt);
            }
        });

        cantFormTF.setEditable(false);
        cantFormTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cantFormTFActionPerformed(evt);
            }
        });
